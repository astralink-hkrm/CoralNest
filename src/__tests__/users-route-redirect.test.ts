...
describe("users route redirect", () => {
  it("redirects legacy /users traffic to the home page", async () => {
    ...
    expect(redirectMock).toHaveBeenCalledWith({ to: "/", replace: true });
  });

  it("redirects legacy /publishers traffic to the home page", async () => {
