...
export const BANNED_SIGN_IN_MESSAGE = `This account is not in good standing and cannot sign in. Please ${ACCOUNT_APPEAL_LINK_TEXT} if you believe this is a mistake.`;
export const DELETED_SIGN_IN_MESSAGE =
  "This account was permanently deleted and cannot sign in again.";
