...
registerCommand(packageCmd, ["package", "explore"])
  ...
  .option("--family <family>", "skill|code-plugin|bundle-plugin|claw|mcp|persona|connectors")
...
registerCommand(packageCmd, ["package", "publish"])
  ...
  .option("--family <family>", "code-plugin|bundle-plugin|claw|mcp|persona|connectors")
